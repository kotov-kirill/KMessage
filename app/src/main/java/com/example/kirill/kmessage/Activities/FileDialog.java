...
public class FileDialog extends ListActivity {
    ...
    public static final String REQUEST_OPEN_MODE = "REQUEST_MODE";
    public static final int REQUEST_FILE_SAVE = 2;
    public static final int REQUEST_FILE_OPEN = 3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int requestMode = getIntent().getIntExtra(REQUEST_OPEN_MODE, 0);
        if(requestMode == REQUEST_FILE_SAVE)
            setContentView(R.layout.file_dialog_main_save);
        else
            setContentView(R.layout.file_dialog_main_open);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
            ...
            if (layoutCreate != null && layoutCreate.getVisibility() == View.VISIBLE) {
                layoutCreate.setVisibility(View.GONE);
                layoutSelect.setVisibility(View.VISIBLE);
            } else {
